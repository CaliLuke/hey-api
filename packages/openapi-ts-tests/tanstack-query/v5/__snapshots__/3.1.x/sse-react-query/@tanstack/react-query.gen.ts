...
import { createEvent, listEvents, type Options } from '../sdk.gen';
import type { CreateEventData, CreateEventResponse, ListEventsData, ListEventsResponse } from '../types.gen';
 ...
 * Create event
 */
export const useCreateEventMutation = (mutationOptions?: Partial<Omit<UseMutationOptions<CreateEventResponse, DefaultError, Options<CreateEventData>>, 'mutationFn'>>) => useMutation({ ...createEventMutation(), ...mutationOptions });
